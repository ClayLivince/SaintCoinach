...
namespace SaintCoinach.Xiv {
    public class DisposalShop : XivRow, IShop, IItemSource {
        ...
        /// <summary>
        ///     <see cref="DisposalShopItem" />s of the current shop.
        /// </summary>
        private DisposalShopItem[] _ShopItems;
        ...
        /// <summary>
        ///     Gets the <see cref="DisposalShopItem" />s of the current shop.
        /// </summary>
        /// <value>The <see cref="DisposalShopItem" />s of the current shop.</value>
        public IEnumerable<DisposalShopItem> Items { get { return _ShopItems ?? (_ShopItems = BuildShopItems()); } }
        ...
        public DisposalShop(IXivSheet sheet, IRelationalRow sourceRow) : base(sheet, sourceRow) { }
        ...
        public Text.XivString Name { get { return AsString("ShopName"); } }
        ...
        /// <summary>
        ///     Build an array of the <see cref="DisposalShopItem" />s of the current shop.
        /// </summary>
        /// <returns>An array of the <see cref="DisposalShopItem" />s of the current shop.</returns>
        private DisposalShopItem[] BuildShopItems() {
            return Sheet.Collection.GetSheet2<DisposalShopItem>()
                .Cast<DisposalShopItem>()
